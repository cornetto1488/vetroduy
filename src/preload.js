...
contextBridge.exposeInMainWorld('api', {
  ...
  overlayToggle: (on) => ipcRenderer.invoke('overlay:toggle', on),
  overlayData: (data) => ipcRenderer.send('overlay:data', data),
  karaokeLyrics: (artist, track) => ipcRenderer.invoke('karaoke:lyrics', artist, track),
